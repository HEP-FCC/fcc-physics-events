...
<html lang="en">
  <head>
    ...
    <title>IDEA | Delphes | Dev | FCC-ee | FCC Physics Events</title>
  ...
  <body>
    ...
    <article id="sample-article" class="container-lg">
      <h1 class="mt-5">FCC-ee | Dev | Delphes | IDEA Samples</h1>

      <p class="mt-3">
        <em>Delphes FCCee Physic events dev production (IDEA with Track Covariance full matrix lower triangle).</em>
      </p>

      <?php include 'stack.php'; ?>

      <p class="mt-5">
        Additional stats about the production can be found <a href="<?= BASE_URL ?>/data/FCCee/statdelphesdev_IDEA.html">here</a>.
      </p>
