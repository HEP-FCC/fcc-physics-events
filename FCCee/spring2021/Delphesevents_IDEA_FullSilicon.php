...
<html lang="en">
  <head>
    ...
    <title>IDEA FullSilicon | Delphes | Spring 2021 | FCC-ee | FCC Physics Events</title>
  ...
  <body>
    ...
    <article id="sample-article" class="container-lg">
      <h1 class="mt-5">FCC-ee | Spring 2021 | Delphes | IDEA FullSilicon Samples</h1>

      <p class="mt-3">
	<em>Delphes FCCee Physic events spring 2021 production (IDEA with Track Covariance full matrix lower triangle)</em>
      </p>

      <?php include 'stack.php'; ?>

      <p class="mt-5">
        Additional stats about the production can be found <a href="<?= BASE_URL ?>/data/FCCee/statdelphesspring2021_IDEA_FullSilicon.html">here</a>.
      </p>
